...
public class ScenarioTest {
    ...
    @Test
    public void testOneProductDifferentAds(){
        AdvertisingFilm ad = new AdvertisingFilm("A super ad", "Lina Zerraf", new Phone());
        Phone iPhoneX = new Phone();
        iPhoneX.setName("iPhone");

        Scenario scenario = new Scenario("Films");

        scenario.addFilm(this.film1);
        scenario.addFilm(this.advertisingFilm);
        scenario.addFilm(ad);

        scenario.oneProductDifferentAds(iPhoneX);

        assertEquals(this.advertisingFilm.getPhone(),this.advertisingFilm.getPhone());
